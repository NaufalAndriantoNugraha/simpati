...
export default function AdminRegister() {
    ...
    const handleSubmit = (e: React.FormEvent) => { e.preventDefault(); post('/admin/register'); };
            ...
            <div className="hidden w-[45%] flex-col justify-between bg-gray-900 p-12 lg:flex">
                ...
                <div>
                    ...
                    <h2 className="text-3xl font-bold leading-snug text-white">
                        Registrasi<br />Akun Admin.
                    </h2>
                    <p className="mt-3 text-sm leading-relaxed text-gray-400">
                        Buat akun admin untuk mengelola program studi, verifikasi pembayaran, dan menerbitkan LOA.
                    </p>
                </div>
            ...
            <div className="flex flex-1 items-center justify-center bg-gray-50 px-6 py-12">
                <div className="w-full max-w-sm">
                    ...
                    <p className="mt-1 text-sm text-gray-500">Sudah punya akun?{' '}
                        <a href="/admin/login" className="font-semibold text-emerald-600 hover:text-emerald-700">Masuk sekarang</a>
                    </p>
