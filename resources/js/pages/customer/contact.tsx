...
export default function Contact() {
    return (
        <StudentLayout active="contact">
            <div className="mb-6">
                <h1 className="text-2xl font-bold">Kontak Admin</h1>
                <p className="w-3/5 text-justify text-gray-500">
                    Apabila Anda mengalami kesulitan dalam menjalankan website atau terdapat hal yang perlu ditanyakan,Anda dapat menghubungi salah
                    satu nomor pengembang yang dicantumkan.
                </p>
            </div>
