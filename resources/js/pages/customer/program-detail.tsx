            ...
            <div className="border border-gray-100 bg-white p-8 shadow-sm">
                ...
                <div className="mb-6 flex items-start justify-between gap-4">
                    <div className="flex items-start gap-4">
                        <div className="flex h-12 w-12 shrink-0 items-center justify-center bg-emerald-50">
                            <BookOpen size={22} className="text-emerald-600" />
                        </div>
                        <div>
                            <h1 className="text-xl font-bold text-gray-900">{program.name}</h1>
                            <span className="mt-1 inline-flex items-center bg-emerald-50 px-2.5 py-0.5 text-xs font-semibold text-emerald-700 ring-1 ring-emerald-200">
                                Pendaftaran Dibuka
                            </span>
                        </div>
                    </div>
                ...
                {/* CTA */}
                {isRegistered ? (
                    <button disabled className="w-full cursor-not-allowed bg-gray-100 py-3 text-sm font-semibold text-gray-400">
                    ...
                    <button onClick={() => setShowModal(true)}
                        className="w-full bg-emerald-600 py-3 text-sm font-semibold text-white hover:bg-emerald-700 transition">
                        Daftar Sekarang
                    </button>
                )}
            </div>
